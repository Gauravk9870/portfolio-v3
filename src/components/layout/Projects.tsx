  ...
  return (
    <>
      <section className=" py-12 md:py-24 px-4 md:px-8 bg-[#000000] flex items-center md:items-start flex-col">
        ...
        <h2 className=" text-5xl font-bold font-sans text-center md:text-left text-white">
        ...
        <div className=" mt-24 flex flex-col gap-10">
          ...
          <div className="overflow-hidden flex flex-col gap-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              ...
              >
                <div
                  className=" relative flex flex-col gap-4 p-8 md:p-10 rounded-3xl"
                  style={{
                    background:
                      "linear-gradient(144deg, rgba(41,31,162,1) 0%, rgba(7,5,102,1) 30%, rgba(3,3,57,1) 58%)",
                  }}
                >
                  <svg
                    ...
                    className=" absolute w-1/4 bottom-0 right-0 opacity-10 "
                  >
                    <path d="m22 2-7 20-4-9-9-4Z" />
                    <path d="M22 2 11 13" />
                  </svg>

                  <h3 className=" text-4xl font-bold font-sans z-10 text-white">
                    Bulk Messenger
                  </h3>
                  <p className=" text-base z-10 text-white">
                    Developed a robust backend system using Node.js, Express.js
              ...
              <div className=" relative flex flex-col justify-between p-10 gap-10 rounded-3xl border border-white/[.4] cursor-pointer">
                ...
                <h4 className=" text-3xl font-bold font-sans z-10 text-white">
                  Development Tools
                </h4>
              </div>
            </div>
                ...
                >
                  <div className="w-full h-60 relative overflow-hidden border border-white/[.4] transition-all duration-200 ease-in-out rounded-xl  ">
                    <Image
                      ...
                      fill={true}
                      className="object-cover w-full h-auto transition-all duration-200 ease-in-out transform hover:scale-110"
                  ...
                  <div className=" pt-4 flex flex-col space-y-2  relative">
                    ...
                    <ul className="w-full flex items-center justify-start flex-wrap gap-2">
                      {project.techology.map((tech, index) => (
                        <li
                          key={index}
                          className="uppercase py-1 px-4 rounded-3xl text-xs border  border-white/[.4]"
                        >
                          {tech}
                        </li>
                      ))}
